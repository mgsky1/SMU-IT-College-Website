...
<?php
   ...
   $list->_construct();
   $ID = intval($_GET['id']);
   $row = $list->getALink($ID);
   $_SESSION['LinkID'] = $row['ID'];
?>
 <!doctype html>
<html>
<head>
...
<body>
   <div class="bread">
            ...
            <li class="active">添加友情链接</li>
             ...
             <form action="updateLink.php" name="form1" method="post">
             <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                    ...
                                    <td align="left"><input type="text" name="LinkName" placeholder="请输入网站名称" required autofocus value="<?php echo $row['LinkName']?>"/></td>
                                   
							</tr>
                            <tr>
									<td align="right">网站地址：</td>
                                    <td align="left"><input type="text" name="URL" placeholder="请输入网址" required value="<?php echo $row['LinkUrl']?>"/></td>
