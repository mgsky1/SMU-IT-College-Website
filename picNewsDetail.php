...
<?php require_once("PHP_Script/picNewsDetail_code.php")?>
...
<div class="sb_box" style=" margin-right:20px">
	    <h3 class="title">
<div class="position">当前位置：<a href="index.php" title="网站首页">网站首页</a> &gt; <a href="listPicNews.php" >图片新闻</a> >
<a href="#" >详细信息</a></div>
			<span>图片新闻</span>
		</h3>
		<div class="clear"></div>
        ...
        <div class="active" id="shownews">
          ...
          <?php showTitle($Data)?>
           ...
           <?php showImg($Data)?>
           <br>
            <span style="text-align:center"> <?php showContent($Data)?></span>
           </div>
            </div>
            <div class="met_page"><?php hasPre($Data)?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php hasNext($Data)?></div>
        </div>
    </div>
    <div class="clear"></div>
</div>
